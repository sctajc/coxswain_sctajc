...
class UserSettings extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var _selectedDistance = _userSettingsBox.get(kFieldDistance) ?? 'meters';
    var _selectedEnergy = _userSettingsBox.get(kFieldEnergy) ?? 'Kcal';
    var _selectedSpeed = _userSettingsBox.get(kFieldSpeed) ?? 'kph';
    var _selectedProgramLevel = _userSettingsBox.get(kFieldProgramLevel) ?? 'Beginners';
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButton<String>(
                  ...
                  items: optionsDistance.map<DropdownMenuItem<String>>((value) {
                ...
                listOptions(
                  optionsDistance, // items
                  _selectedDistance, //value
                  'Distance', // label
                  kFieldDistance, // database name (key)
                  'Choose the measurement type for distance you row', // help one
                  'Do you work in meters, miles or whatever', // help two
                  context,
                ),
                listOptions(
                  optionsEnergy,
                              ...
                              SizedBox(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    errorBorder: InputBorder.none,
                                    disabledBorder: InputBorder.none,
                                    hintText: 'https://www.youtube.com/playlist?list=WL&playnext=1',
                                    labelStyle: TextStyle(
                                      color: kColorBlue,
                                    ),
                                  ),
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: DropdownButton<String>(
                        ...
                        onChanged: (value) {
                          FocusScope.of(context).unfocus(); // dismiss keyboard
                          _userSettingsBox.put(_databaseFieldName, value);
                          print('saved $_databaseFieldName with $value');
                        },
                      ),
                    ),
                  ),
