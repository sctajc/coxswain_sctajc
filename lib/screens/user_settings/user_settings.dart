...
class UserSettings extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var _selectedWeight =
        _userSettingsBox.get(kFieldWeight) ?? 0; // 0 = Kg, 1 = pounds
    ...
    var _selectedSegmentInstruction =
        _userSettingsBox.get(kFieldSegmentInstruction) ?? 0;
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        onChanged: (value) =>
                            _userSettingsBox.put(kFieldUserName, value),
                      ),
                    ),
                    SizedBox(
                      width: 10,
                      ...
                      children: [
                                ...
                                Expanded(
                                  child: TextFormField(
                                    ...
                                    onChanged: (value) {
                                      ...
                                      _userSettingsBox.put(
                                          kFieldUserWeight, value);
                                    },
                                  ),
                                ),
                                Container(
                        ...
                        YesNoOption(
                            ...
                            selectedInitialValue:
                                _selectedAdjustEnergyToBodyWeight,
                            ...
                            helpLineTwo:
                                'Ensure your body weight is entered accurately. ',
                            context: context),
                      ],
                    ),
                  ),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: TextFormField(
                                  onTap: () => _userSettingsBox.put(
                                      kFieldStartActualURL,
                                      'https://www.youtube.com/playlist?list=WL&playnext=1'),
                                  ...
                                  onChanged: (value) => _userSettingsBox.put(
                                      kFieldStartActualURL, value),
                                ),
                              ),
                            ],
                          ),
                ...
                YesNoOption(
                    ...
                    helpLineOne:
                        'Keep recording your workout even if the Program has completed.',
                ...
                YesNoOption(
                    ...
                    helpLineOne:
                        'After every workout automatically update your Fit records.',
                    helpLineTwo:
                ...
                YesNoOption(
                    ...
                    helpLineOne:
                        'After every workout automatically update your Strada records.',
                    helpLineTwo:
                ...
                YesNoOption(
                    ...
                    helpLineTwo:
                        'File will be exported to /coxswain/workout/????.tcx',
                    context: context),
                SizedBox(
                  height: 20,
                ),
                ...
                YesNoOption(
                    ...
                    helpLineOne:
                        'Play a sound at the start of each Workout Segment.',
                    helpLineTwo:
                        'You may just want voice instructions for each segment change.',
                    context: context),
                YesNoOption(
                    userSettingsBox: _userSettingsBox,
                    optionHeading: 'Voice',
                    ...
                    helpLineOne:
                        'Give voice instructions at the start of each Program Segment.',
                    helpLineTwo:
                        'You may just prefer a sound for each segment change',
                    context: context),
                SizedBox(
                  height: 20,
                ),
                ...
                YesNoOption(
                    ...
                    helpLineTwo:
                        'You maybe asked to turn this on if receiving technical support',
                    context: context),
                YesNoOption(
                    userSettingsBox: _userSettingsBox,
                    optionHeading: 'Trace',
